...
for(var j=1;j<max_length;j=j+10){
  ...
  while(sentence.length < j){
    ...
    metrics = tick(sentence.slice(0, j));
    console.log(j+", "+metrics.time)
}
//repl;
//var iid = null;
// $(function() {
